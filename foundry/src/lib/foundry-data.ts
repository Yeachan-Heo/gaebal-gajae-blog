...
export const tokenGroups: readonly TokenGroup[] = [
  ...
  },
  {
    ...
    tokens: [
      ...
      { token: 'surface-terminal-code', preview: 'surface', usage: { ko: 'evidence code / inline receipt chip', en: 'Evidence code and inline receipt chips', zh: '证据 code / 行内 receipt chip', ja: '証拠 code / インライン receipt chip' }, description: { ko: '증거 문맥 안에서 code와 inline receipt를 받치는 작은 패널.', en: 'Small panel behind code and inline receipt details inside evidence contexts.', zh: '在证据语境中承载 code 与行内 receipt 的小面板.', ja: 'evidence 文脈の中で code と inline receipt を支える小パネル.' } },
    ],
  },
] as const;
