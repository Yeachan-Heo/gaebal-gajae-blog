...
export const tokenGroups: readonly TokenGroup[] = [
  {
    ...
    description: { ko: 'Editorial Logbook 프리뷰에서 바탕 면, 읽기 면, 메시지 패널, 선택 상태를 역할별 높이로 분리한다.', en: 'In the Editorial Logbook preview, separate the field, reading sheets, message plates, and selected states by semantic height.', zh: '在 Editorial Logbook 预览中，按语义高度分开底面、阅读面、消息面板与选中状态。', ja: 'Editorial Logbook プレビューでは、地面、読む面、メッセージ面、選択状態を意味のある高さで分ける。' },
    tokens: [
      { token: 'paper-canvas', preview: 'surface', usage: { ko: '전체 로그북 바탕', en: 'Editorial page field', zh: '整张日志底面', ja: 'ログ全体の地面' }, description: { ko: '따뜻한 paper-canvas를 전체 읽기 면의 기본 바탕으로 쓴다.', en: 'Warm paper-canvas forms the default field for the entire reading surface.', zh: '用温暖的 paper-canvas 作为整个阅读表面的默认底面。', ja: '暖かな paper-canvas を全体の読む面の基本フィールドにする。' } },
      { token: 'surface-panel', preview: 'surface', usage: { ko: '기본 카드 / 본문 섹션', en: 'Base cards and body sections', zh: '基础卡片 / 正文区块', ja: '基本カード / 本文セクション' }, description: { ko: '가장 자주 쓰는 읽기 표면. 배경보다 한 단계만 올라오고, 액센트보다 먼저 나서지 않는다.', en: 'Default reading surface. It rises only one step above the field and never shouts before the accent.', zh: '最常用的阅读表面。它只比底面高一层，且不会先于 accent 喊出来。', ja: 'もっとも多く使う読む面。地面より一段だけ上がり、accent より先に叫ばない。' } },
      { token: 'surface-panel-soft', preview: 'surface', usage: { ko: '메시지 패널 / 미디어 프레임', en: 'Message panels and media frames', zh: '消息面板 / 媒体框', ja: 'メッセージパネル / メディアフレーム' }, description: { ko: '보조 정보가 본문과 경쟁하지 않도록 한 단계 물린 조용한 읽기 표면.', en: 'Quiet intermediate reading surface that keeps support information behind the body.', zh: '让辅助信息退到正文之后的一层安静阅读表面。', ja: '補助情報を本文の後ろへ下げる静かな中間の読む面。' } },
      { token: 'surface-panel-wash', preview: 'surface', usage: { ko: '조용한 유틸 패널 / 보조 플레이트', en: 'Quiet utility panels and support plates', zh: '安静工具面板 / 辅助面', ja: '静かなユーティリティ面 / 補助プレート' }, description: { ko: 'JSON colors.customMessageBg와 toolPendingBg가 기대는 mantle 계열 바닥. 주 표면보다 한 단계 눌러서 보조 정보가 뒤로 물러난다.', en: 'Mantle-level base that JSON colors.customMessageBg and toolPendingBg lean on. It sits one step behind the main reading surface so support information recedes.', zh: 'JSON colors.customMessageBg 与 toolPendingBg 依附的 mantle 底面。它比主阅读表面再退一层，让辅助信息后退。', ja: 'JSON の colors.customMessageBg と toolPendingBg が寄りかかる mantle レベルの土台。主読む面より一段引くことで補助情報を後ろへ下げる。' } },
      { token: 'surface-panel-strong', preview: 'surface', usage: { ko: '강조 카드 / docs preview', en: 'Lifted cards and docs previews', zh: '抬起卡片 / docs 预览', ja: '持ち上げたカード / docs プレビュー' }, description: { ko: '본문보다 한 단계 올라오되 액센트보다 먼저 소리치지 않는 강조 표면.', en: 'A lifted surface that rises above prose without speaking before the accent.', zh: '比正文抬高一层、但不会先于 accent 发声的强调表面。', ja: '本文より一段上がりながら、accent より先に叫ばない強調面。' } },
      { token: 'paper-sheet-raised', preview: 'surface', usage: { ko: '현재 선택 / 활성 상태', en: 'Selected and active state', zh: '当前选择 / 激活状态', ja: '現在選択 / アクティブ状態' }, description: { ko: '현재 위치와 선택 상태를 분명하게 보여 주되 페이지 전체를 칠하지 않는 상태 표면.', en: 'Clear selected-state surface that marks current location without painting the whole page.', zh: '清楚标记当前位置、但不会涂满整页的选中状态表面。', ja: '現在位置を明確にしながら、ページ全体を塗らない選択状態の面。' } },
      { token: 'nav-surface', preview: 'surface', usage: { ko: '상단 인덱스 바', en: 'Editorial index bar', zh: '编辑索引条', ja: '編集インデックスバー' }, description: { ko: '짧은 링크와 조작을 안정적으로 담는 상단 인덱스 바.', en: 'Stable top index bar for short links and controls.', zh: '稳定承载短链接与控制项的顶部编辑索引条。', ja: '短いリンクと操作を安定して収める上部インデックスバー。' } },
      { token: 'surface-panel-soft', preview: 'surface', usage: { ko: '언어 / 토글 묶음 배경', en: 'Locale and toggle cluster', zh: '语言 / 切换簇背景', ja: '言語 / トグル群の背景' }, description: { ko: '상단 바 안에서 작은 조작 묶음을 한 덩어리로 잡는 보조 표면.', en: 'Support surface that groups tiny controls inside the top bar.', zh: '把顶部条里小控制组拢成一块的辅助表面。', ja: '上部バーの小さな操作群を一塊にまとめる補助面。' } },
    ],
  },
  {
    id: 'ink',
    ...
    tokens: [
      ...
      { token: 'line', preview: 'border', usage: { ko: '분리선 / rail / 표 구획', en: 'Rules, rails, and table dividers', zh: '分隔线 / rail / 表格区分', ja: '区切り線 / rail / 表区分' }, description: { ko: '기본 구조선은 theme border 값을 직접 받는다. 더 조용한 하위 구획만 muted border로 내린다.', en: 'Primary structure lines take the theme border directly; only quieter subdivisions fall back to muted border.', zh: '主结构线直接使用主题 border；只有更安静的次级区分才退回 muted border。', ja: '基本の構造線はテーマの border を直接使い、さらに静かな下位区分だけを muted border へ落とす。' } },
    ],
  },
  {
    id: 'accent-status',
    title: { ko: 'Accent & status', en: 'Accent & status', zh: '强调与状态', ja: 'アクセントと状態' },
    description: { ko: '같은 semantic 슬롯을 쓰더라도 Editorial Logbook의 액센트와 warning은 서로 다른 역할로 읽혀야 한다.', en: 'Even when they share semantic slots, Editorial Logbook accents and warnings must keep distinct roles.', zh: '即使复用同一 semantic 槽位，Editorial Logbook 的 accent 与 warning 也必须保持不同角色。', ja: '同じ semantic スロットを使っても、Editorial Logbook の accent と warning は役割を分けて読ませる。' },
    tokens: [
      { token: 'accent', preview: 'text', usage: { ko: 'primary action / 강조 링크', en: 'Primary actions and emphasized links', zh: '主要动作 / 强调链接', ja: 'primary action / 強調リンク' }, description: { ko: 'lobster accent는 대표 CTA와 현재 위치 같은 작성자 신호에만 쓴다.', en: 'Use the lobster accent only for authored signals such as primary CTAs and current location.', zh: 'lobster accent 只用于主 CTA 与当前位置等作者信号。', ja: 'lobster accent は主 CTA や現在位置のような著者シグナルだけに使う。' } },
      { token: 'lobster-soft', preview: 'surface', usage: { ko: '선택 / 코드 / 얕은 강조 wash', en: 'Selection, code, and soft accent wash', zh: '选区 / 代码 / 轻强调薄层', ja: '選択 / コード / 淡い accent wash' }, description: { ko: '강한 채움이 아니라 힌트 수준에서만 보이는 테마별 accent 얇은 막.', en: 'Thin theme-specific accent wash that stays at hint level instead of becoming a filled panel.', zh: '只停留在提示级别、不会变成整块填充面的主题专属 accent 薄层。', ja: '強い塗り面にはならず、ヒント程度にだけ見えるテーマ別 accent の薄膜。' } },
      { token: 'verified-default', preview: 'text', usage: { ko: '검증 완료 / 통과 신호', en: 'Verified pass signal', zh: '验证完成 / 通过信号', ja: '検証完了 / 通過シグナル' }, description: { ko: '통과와 재현 가능 상태를 말할 때만 뜨는 sage 신호.', en: 'Sage signal reserved for passes and reproducible completion.', zh: '只在通过与可复现完成时升起的 sage 信号。', ja: '通過と再現可能な完了を示すときだけ立ち上がる sage シグナル。' } },
      { token: 'verified-soft', preview: 'surface', usage: { ko: 'verified 배경 / rail', en: 'Verified backgrounds and rails', zh: 'verified 背景 / rail', ja: 'verified 背景 / rail' }, description: { ko: 'success 신호 밑에 조용히 깔리는 얇은 받침 면.', en: 'Quiet backing wash under the success signal.', zh: '静静垫在 success 信号下面的一层薄背景。', ja: 'success シグナルの下に静かに敷かれる薄い受け面。' } },
      { token: 'warning-default', preview: 'text', usage: { ko: '주의 / incident signal', en: 'Warning and incident signal', zh: '注意 / incident 信号', ja: '注意 / incident シグナル' }, description: { ko: '메인 accent보다 더 뜨겁고 짧은 ember 경고. 카드 전체를 칠하지 말고 rail이나 stamp로만 쓴다.', en: 'Hotter ember warning than the main accent. Keep it to rails and stamps instead of painting the whole card.', zh: '比主 accent 更炽热、更短促的 ember 警示。只用在 rail 或 stamp 上，别涂满整张卡片。', ja: '主 accent より熱く短い ember 警告。カード全体を塗らず、rail や stamp にだけ使う。' } },
  ...
  },
  {
    ...
    description: { ko: 'repo, build, proof signal처럼 확인용 정보는 Editorial Logbook의 graphite slab 흐름을 따라 별도 증거층에 묶는다.', en: 'Repo, build, and proof metadata stay in a separate evidence layer with the Editorial Logbook graphite slab treatment.', zh: 'repo、build、proof 这类确认信息会沿用 Editorial Logbook 的石墨 slab 逻辑，被束进独立证据层。', ja: 'repo、build、proof のような確認情報は Editorial Logbook の graphite slab の流れに沿う独立証拠レイヤーに束ねる。' },
    tokens: [
      { token: 'surface-terminal', preview: 'surface', usage: { ko: 'proof panel / 증거 카드 바닥', en: 'Proof panels and evidence-card base', zh: 'proof panel / 证据卡底面', ja: 'proof panel / 証拠カードの土台' }, description: { ko: '증거 계층의 가장 깊은 graphite 바닥.', en: 'Deep graphite floor for the evidence layer.', zh: '证据层最深的石墨底面。', ja: '証拠レイヤーでもっとも深い graphite の土台。' } },
      { token: 'surface-terminal-soft', preview: 'surface', usage: { ko: '증거 헤더 / 상단 띠', en: 'Evidence headers and lifted top strips', zh: '证据头部 / 上方条带', ja: '証拠ヘッダー / 上部ストリップ' }, description: { ko: '증거 카드 안에서 한 단계 떠 있는 상단면.', en: 'Lifted sub-surface used for headers inside evidence cards.', zh: '证据卡内部抬起一层的头部表面。', ja: '証拠カード内部で一段持ち上がるヘッダー面。' } },
      { token: 'surface-terminal-wash', preview: 'surface', usage: { ko: 'proof signal item', en: 'Proof signal items', zh: 'proof signal 条目', ja: 'proof signal 項目' }, description: { ko: 'dark slab 안에서 receipt 조각을 나누는 작은 조각면.', en: 'Small receipt-like chip inside the dark evidence slab.', zh: '在深色证据层内部切分 receipt 的小表面。', ja: 'dark slab の中で receipt を区切る小さなチップ面。' } },
      ...
      { token: 'line-strong', preview: 'border', usage: { ko: 'evidence divider / chip 경계', en: 'Evidence dividers and chip borders', zh: '证据分隔线 / chip 边界', ja: '証拠の区切り線 / chip 境界' }, description: { ko: '어두운 바닥에서도 receipt 구조를 보이게 만드는 선.', en: 'Divider that preserves receipt structure on the dark slab.', zh: '让深色证据层里仍能看出 receipt 结构的边界线。', ja: '暗い slab の上でも receipt 構造を見せる境界線。' } },
      { token: 'surface-terminal-soft', preview: 'surface', usage: { ko: 'evidence code / inline receipt chip', en: 'Evidence code and inline receipt chips', zh: '证据 code / 行内 receipt chip', ja: '証拠 code / インライン receipt chip' }, description: { ko: '증거 문맥 안에서 code와 inline receipt를 받치는 작은 패널.', en: 'Small panel behind code and inline receipt details inside evidence contexts.', zh: '在证据语境中承载 code 与行内 receipt 的小面板。', ja: 'evidence 文脈の中で code と inline receipt を支える小パネル。' } },
    ],
  },
] as const;
