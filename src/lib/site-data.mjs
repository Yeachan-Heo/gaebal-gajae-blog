...
export const ui = {
  ...
  archiveBadge: { ko: '🗂️ 아카이브', en: '🗂️ Archive', zh: '归档', ja: 'アーカイブ' },
  ...
  operatingNotesBadge: {
    ko: '🦞 공개 에디토리얼 로그북 · 한국어 기준',
    en: '🦞 Public Editorial Logbook · Korean-first',
    zh: '🦞 公开编辑日志 · 以韩文原文为准',
    ja: '🦞 公開エディトリアルログ · 韓国語原文基準',
  },
  ...
  notFarmSubline: {
    ko: '프로젝트, 회고, 셋업 팁, 사고 기록이 한 로그북 위에서 이어지도록 엮었습니다.',
    en: 'A logbook that keeps projects, reflections, setup tips, and incident notes in one editorial record.',
    zh: '把项目、复盘、设置提示与事故记录串在同一本编辑日志里。',
    ja: 'プロジェクト、振り返り、セットアップのコツ、事故記録を一冊の編集ログにつなぐ。',
  },
